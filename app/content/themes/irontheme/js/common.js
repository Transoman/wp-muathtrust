...
(function (global){(function (){
'use strict'; // import datepicker from 'air-datepicker';
...
jQuery(document).ready(function ($) {
  ...
  .not('[href="#"]').not('[href="#0"]').not('.fees-and-payment-tabs__list a').click(function (event) {
    // On-page links
  ...
  var hireForm = function hireForm() {
    var room = $('select[name="hire_accommodation"]');

    if (room.length) {
      var selectedPrice = room.find('option:selected').data('custom-properties');
      var priceBlock = $('.select-price span');
    ...
    var form = $('.hire-form--step-6');

    if (form.length) {
      var checkTerm = form.find('input[name="hire_statemant"]');
  ...
  var fixedHeader = function fixedHeader() {
    ...
    var offsetShow = document.documentElement.clientHeight / 1.5;
  ...
  var aboutBlock = function aboutBlock() {
    var listItems = $('.about-block__links-item');
    var id = null;
  ...
  var hireServiceForm = function hireServiceForm() {
    ...
    type.change(function () {
      ...
      var value = $(this).val();
      var oneTimeBlock = $('.one-time');
      var blockTimeBlock = $('.block-time');
    ...
    $(document).on('change', '.hire-service-form__datetime-date', function () {
      ...
      var select = $(this).parents('.hire-service-form__datetime').find('.hire-service-form__datetime-time');
      $.ajax({
        url: window.wp_data.ajax_url,
        data: {
...
},{"choices.js":1,"imask":2,"jquery-popup-overlay":3,"js-cookie":5,"svg4everybody":6,"swiper/swiper-bundle":7}]},{},[8]);
